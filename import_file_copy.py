...
def main():
    file_name_path = '/Users/pangdembe/Desktop/import_file' #current directory
    ...
    if not table_exists(table_names_df):
        ...
        try:
            ...
            print(f"Table {table_names_df} created successfully\n")
        except (Exception, psycopg2.DatabaseError) as error:
            print("ERROR: ", error)
    else:
        print(f"Table {table_names_df} exists. Dropping table.")
        try:
            drop_table=drop_table_statement(table_names_df)
            print(f"Table {table_names_df} dropped successfully\n")
        except (Exception, psycopg2.DatabaseError) as error:
            print("ERROR: ", error)
            print('Generating DDL statements.')
            create_queries = write_ddl(all_columns, table_names_df)
